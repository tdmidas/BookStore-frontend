					...
					<div className="col-md-8">
						<div className="list-group-flush">
							<div className="list-group-item">
								...
								{order.isDelivered ? (
									<Message variant={"alert-success"}>Delivered on {order.deliveredAt}</Message>
								) : (
							...
							<div className="list-group-item pt-4">
								...
								{order.isPaid ? (
									<Message variant={"alert-success"}>Paid on {order.paidAt}</Message>
								) : (
						...
						<div className="card">
							<div className="list-group">
								...
								{userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
									<div className="list-group-item bg-color">
										<button className="btn order-btn" onClick={deliverHandler}>
											Mark As Delivered
										</button>
									</div>
								)}
